...
$(document).ready(function () {
    ...
    $('.listContact .btnViewContact').click(function () {
        ...
        if ($(blockContactElement).attr('id') !== $(blockPreview).attr('data-contactid')) {
            ...
            contactInformation.email = $(blockContactElement).find('.is_hidden .emailContact')[0].textContent;
            ...
            contactInformation.telephone = $(blockContactElement).find('.is_hidden .telephoneContact')[0].textContent;
            contactInformation.siteWeb = $(blockContactElement).find('.is_hidden .siteWebContact')[0].textContent;
            ...
            $(allBlockPreview).slideUp('fast', function () {
                setTimeout(function(){
                    ...
                    $(blockPreview).find('.previewEmailContact span.content')[0].textContent = contactInformation.email;
                    ...
                    $(blockPreview).find('.previewTelephoneContact span.content')[0].textContent = contactInformation.telephone;
                    $(blockPreview).find('.previewSiteWebContact span.content')[0].textContent = contactInformation.siteWeb;
                }, 200);
            });
